...
public :: refsor
private :: kdp
private :: R_refsor, D_refsor, I_refsor, I8_refsor
private :: R_inssor, D_inssor, I_inssor, I8_inssor
private :: R_subsor, D_subsor, I_subsor, I8_subsor
interface refsor
  module procedure d_refsor, r_refsor, i_refsor, i8_refsor
...
! __________________________________________________________
! __________________________________________________________
      Integer(8), Dimension (:), Intent (InOut)  :: XDONT
! __________________________________________________________
!
!
      Call I8_subsor (XDONT, int(1,8), int(Size(XDONT),8))
      Call I8_inssor (XDONT)
      Return
End Subroutine I8_refsor
Recursive Subroutine I8_subsor (XDONT, IDEB1, IFIN1)
!  Sorts XDONT from IDEB1 to IFIN1
! __________________________________________________________
      Integer(8), dimension(:), Intent (InOut) :: XDONT
      Integer(8), Intent (In) :: IDEB1, IFIN1
! __________________________________________________________
      Integer(8), Parameter :: NINS = 16 ! Max for insertion sort
      Integer(8) :: ICRS, IDEB, IDCR, IFIN, IMIL
      Integer(8) :: XPIV, XWRK
!
      IDEB = IDEB1
      IFIN = IFIN1
...
!  One now sorts each of the two sub-intervals
!
         Call I8_subsor (XDONT, IDEB1, ICRS-1)
         Call I8_subsor (XDONT, IDCR, IFIN1)
      End If
      Return
   End Subroutine I8_subsor
   Subroutine I8_inssor (XDONT)
!  Sorts XDONT into increasing order (Insertion sort)
! __________________________________________________________
      Integer(8), dimension(:), Intent (InOut) :: XDONT
! __________________________________________________________
